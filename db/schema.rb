...
ActiveRecord::Schema.define(version: 20170724151744) do
  ...
  create_table "boilerplates", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["brand_id"], name: "index_boilerplates_on_brand_id", using: :btree
  end
  ...
  add_foreign_key "boilerplates", "brands"
