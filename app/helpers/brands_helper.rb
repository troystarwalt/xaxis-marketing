...
module BrandsHelper
  ...
  def content_for_brands
    {xaxis: {
      ...
      boilerplate: "<p>Xaxis is a global digital media platform that programmatically connects advertisers to audiences across all addressable channels. Through the expert use of proprietary data and advertising technology along with unparalleled media relationships, Xaxis delivers results for clients in 47 markets across North America, Europe, Asia Pacific, Latin America and the Middle East. Advertisers working with Xaxis achieve exceptionally high return on advertising spend through the company’s proprietary media products, as well as through its specialist companies, Triad Retail Media, Light Reaction and plista.  For more information, visit <a href='https://www.xaxis.com'>www.xaxis.com</a>.</p>",
